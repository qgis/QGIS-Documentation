...
\qgistip{
If you open the \textit{Project Properties} dialog from the \textit{Settings} menu, you
must
...
The \textit{Custom Projections} dialog requires only two parameters to define a user
projection: 
\begin{enumerate}
