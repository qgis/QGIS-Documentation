...
toolbar button\index{shapefile!loading} or simply type V. This same tool can be used to
...
You can add new vertices to a feature by using the \textit{Add Vertex} icon
on the toolbar.
...
You can move vertices using the \textit{Move Vertex} icon
on the toolbar.

\minisec{Deleting Vertices of a Feature}
\index{vector layers!deleting!vertex}

You can delete vertices by using the \textit{Delete Vertex} icon
on the toolbar.
