...
\hline 
FIXME \includegraphics[width=0.7cm]{spit} & SPIT \index{plugins!SPIT}& Shapefile to PostGIS Import Tool - import shapefiles into PostgreSQL\\
\hline
...
\hline
%FIXME \includegraphics[width=0.7cm]{mIconAddWfsLayer}
