...
.. toctree::
   ...
   QGIS Desktop User Guide/Manual (QGIS 3.34) <user_manual/index>
   QGIS Server Guide/Manual (QGIS 3.34) <server_manual/index>
...
.. toctree::
   ...
   PyQGIS Cookbook (QGIS 3.34) <pyqgis_developer_cookbook/index>
