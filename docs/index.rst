...
.. toctree::
   ...
   QGIS Desktop User Guide/Manual (QGIS 3.16) <user_manual/index>
   QGIS Server Guide/Manual (QGIS 3.16) <server_manual/index>
...
.. toctree::
   ...
   PyQGIS Cookbook (QGIS 3.16) <pyqgis_developer_cookbook/index>
