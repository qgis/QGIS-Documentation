...
This is done on the project level (properties). Relations enable you to define
interconnected features. QGIS provide a wide range of functions and tools to handle
