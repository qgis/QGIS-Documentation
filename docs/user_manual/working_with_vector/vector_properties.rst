...
* :guilabel:`Categorized`: features are rendered using user-defined 3D symbols that visually represent their values.
  See :ref:`Categorized renderer <categorized_renderer>` for detailed usage.
* :guilabel:`Rule-based`: multiple 3D symbol configurations can be defined and applied
