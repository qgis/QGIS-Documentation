...
At the bottom of the dialog, the :guilabel:`Preview Attributes Form` panel shows a live
preview of the form being designed and lets you edit it without requiring the
vector layer to be in editing mode.

.. _figure_preview_attributes_form:

.. figure:: img/preview_attributes_form.png
   :align: center
   :width: 50%

   Preview Attributes Form panel
