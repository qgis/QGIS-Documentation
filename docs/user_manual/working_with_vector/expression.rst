...
.. csv-table::
   ...
   "symbol_count", "Returns the total number of features represented by the symbol (in layout legend)"
   "symbol_id", "Returns the Internal ID of the symbol (in layout legend)"
   "symbol_label", "Returns the label for the symbol (either a user defined
   label or the default autogenerated label - in layout legend)"
