...
Returns TRUE if an array contains all the values of a second array.
...
.. list-table::
   ...
   * - Arguments
     - * **array1** - an array
       * **array2** - the array of values to search
   * - Examples
...
.. list-table::
   ...
   * - Syntax
     - array_prioritize(array, priority)
   * - Arguments
     - * **array** - an array
       * **priority** - an array with values ordered by priority
   * - Examples
