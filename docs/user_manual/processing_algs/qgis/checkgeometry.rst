...
.. list-table::
   ...
   * - **Line intersecting other layer features**
     ...
     - [line]
       ...
       Default: ``[Skip output]``
     - Line layer with the features that intersect the check layer.
       :ref:`One of <output_parameter_widget>`:
...
.. list-table::
   ...
   * - **Line intersecting other layer errors**
     ...
     - Output point layer representing the error locations and information
       (the ID and name of the input layer, the geometry part,
       ring and vertex index of the erroneous feature,
       x and y coordinates of the error and the index of the feature in the check layer that is intersected).
   * - **Line intersecting other layer features**
     - ``OUTPUT``
     - [vector: line]
