...
.. list-table::
   ...
   * - **Method**
     ...
     - Method to apply to the gap fixing. Possible values are:
       ...
       * 0 --- ``Add to longest shared edge``:
         adds the gap to the neighboring feature with the longest shared edge.
       * 1 --- ``Create new feature``:
         creates a new feature for each gap.
       * 2 --- ``Add to largest neighbouring area``:
         adds the gap to the neighboring feature with the largest area.
   * - **Field of original feature unique identifier**
     - ``UNIQUE_ID``
     - [tablefield: any]
...
.. list-table::
   ...
   * - **Gaps-filled layer**
     - ``OUTPUT``
     - [vector: polygon]
     - Output layer of polygons without gaps.
       The layer contains the same fields as in the input layer.
...
.. list-table::
   ...
   * - **Small polygons merged layer**
     - ``OUTPUT``
     - [vector: polygon]
     - Output layer of polygons with small polygons merged according to the chosen method.
       The layer contains the same fields as in the input layer.
