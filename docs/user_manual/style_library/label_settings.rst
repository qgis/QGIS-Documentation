...
#. Set the :guilabel:`Label anchor point`: controls where the connector
   line should join to the label text. Available options include:

   * :guilabel:`Closest point`
   * :guilabel:`Label centroid`
   * Fixed corners, ie :guilabel:`Top left`, :guilabel:`Top center`,
