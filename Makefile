...
LANGUAGES       = en bg cs de es fi fr hu id it ja ko nl pt_BR pt_PT ro ru tr zh_Hant zh_Hans
SPHINXOPTS      =
...
#SITEDIR         = /var/www/qgisdata/QGIS-Documentation-3.16/live/html
...
site: html zip
	rsync -hrzc --delete --progress $(BUILDDIR)/html/$(LANG) $(SITEDIR)/;
