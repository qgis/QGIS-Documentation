...
**Map file**
   Enter the name for the map file to be created. You can use the button at 
   the right to browse for the directory where you want the map file created.
**Qgis project file**
   Enter the full path to the QGIS project file (.qgs) you want to export. 
...
Only the :guilabel:`Map file` and :guilabel:`QGIS project file` inputs are 
