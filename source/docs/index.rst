...
.. toctree::
   ...
   User guide/Manual (QGIS 2.2) <user_manual/index>
   User guide/Manual PDF's <http://docs.qgis.org/2.2/pdf/>
   PyQGIS cookbook (QGIS 2.2) <pyqgis_developer_cookbook/index>
