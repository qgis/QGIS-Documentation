...
.. note:: The sample data used in this module is part of the training manual data set and can be `downloaded here  <http://qgis.org/downloads/data/training_manual_exercise_data.zip>`_.
