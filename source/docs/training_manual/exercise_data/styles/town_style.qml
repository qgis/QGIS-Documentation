...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/bufferColorB" value="107"/>
    <property key="labeling/bufferColorG" value="107"/>
    <property key="labeling/bufferColorR" value="107"/>
    ...
    <property key="labeling/dataDefined/Italic" value="1~~0~~~~place"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="is_in"/>
