...
The :guilabel:`Variables` also allows the user to manage composer-item-level
variables. Click the |signPlus| button to add a new custom
composer-item-level variable. Likewise, select a custom composer-item-level
variable from the list and click the |signMinus| button to remove it.
