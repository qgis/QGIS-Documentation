...
* The button **[Attributes...]** starts the :guilabel:`Select attributes` menu, see 
  ...
  * Select a cell in the Headings column to change the Heading, just type in a new name.
  * Select a cell in the Alignment column and you can choose between Left, Center or Right alignment.
  * Select a cell in the Width column and you can change it from Automatic to a width in mm, just 
...
* Click |checkbox| :guilabel:`Show empty rows` to fill the attribute table with empty cells. This option can
