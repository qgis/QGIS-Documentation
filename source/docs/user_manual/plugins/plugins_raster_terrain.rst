...
* **Aspect**: Calculates the direction in which the slope faces. Aspect is calculated in degrees, ranging in value from 0 to 360 degrees, where 0 = North, 90 = East, 180 = South, 270 = West and 360 = North. Flat areas are assigned a value of no data.
