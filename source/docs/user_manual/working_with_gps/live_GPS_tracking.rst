...
* |radiobuttonon| :guilabel:`Internal`,
* |radiobuttonon| :guilabel:`Serial device`
* |radiobuttonon| :guilabel:`gpsd` (selecting Host, Port and Device your
  GPS is connected to).
...
Finally you can activate |checkbox| :guilabel:`Log file` and define a path and a
