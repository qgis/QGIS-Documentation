...
\minisec{qgis-de}
For the german speaking audience we also provide a qgis-de mailing list. Just
like the qgis-users mailing list it is used for discussion of QGIS in
general, as well as specific questions regarding its installation and
use. You can subscribe to the qgis-users mailing list by visiting the
following URL: \\
