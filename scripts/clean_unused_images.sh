...
find ./resources/en -type f -regex ".*\.\(png\|PNG\|gif\|jpg\|jpeg\)" -printf "%f\n" | sort -u > all_images.txt
...
grep -vf found.txt all_images.txt | xargs -I filename find ./resources/en -name filename > not_found.txt
