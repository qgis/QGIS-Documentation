...
---------------------------------------------
Working with OGC Data}\label{working_with_ogc
---------------------------------------------
...
WMS Client}\label{sec:ogc-wms}:index:`WMS!client}\index{OGC!WMS!client
======================================================================
\index{rasters!WMS`

Overview of WMS Support}\label{sec:ogc-wms-about
************************************************
...
Selecting WMS Servers}\label{sec:ogc-wms-servers
************************************************
...
Loading WMS Layers}\label{sec:ogc-wms-layers
********************************************
...
Transparency}\label{ogc-wms-transparency
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
% Identify
%
Using the Identify Tool}\label{sec:ogc-wms-identify
***************************************************
...
Viewing Properties}\label{sec:ogc-wms-properties
------------------------------------------------
...
Metadata Tab}\label{sec:ogc-wms-properties-metadata
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
standards FIXME\cite{OGCWMS010101web}, FIXME\cite{OGCWMS010300web}, but
...
*  **Image Formats**    - The list of MIME-types the server can respond with when
                                  drawing the map.  QGIS supports whatever formats
                                  the underlying Qt libraries were built with, which
                                  is typically at least ``image/png``
                                  and ``image/jpeg``.

*  **Identity Formats** - The list of MIME-types the server can respond with when
...
*  **Visible**          - Whether or not this layer is selected as visible
...
*  **Can be Transparent** - Whether or not this layer can be rendered with transparency.
                                    This version of
...
*  **Cascade Count**    - WMS servers can act as a proxy to other WMS servers to get
...
*  **WGS 84 Bounding Box** - The bounding box of the layer, in WGS 84 coordinates.
                                     ...
                                     ``LatLonBoundingBox``,
                                     ``EX\_GeographicBoundingBox`` or
                                     the CRS:84 ``BoundingBox``.

*  **Available in CRS** - The projections that this layer can be rendered in by
                                  the WMS server.  These are listed in the WMS-native format.

*  **Available in style** - The image styles that this layer can be rendered in by
                                    the WMS server.
...
WMS Client Limitations}\label{sec:ogc-wms-limits
************************************************
...
% WFS-client
%
WFS and WFS-T Client}\label{sec:ogc-wfs
=======================================
...
http://www2.dmsolutions.ca/cgi-bin/mswfs_gmap
  ...
  #.  Click \button{OK}
  #.  Choose \selectstring{Server Connections}{DM Solutions} from the drop-down box
  #.  Click \button{Connect}
  #.  Wait for the list of layers to be populated
  #.  Click on the \clicklistitem{Parks} layer
  #.  Click \button{Ok} to add the layer to the map
