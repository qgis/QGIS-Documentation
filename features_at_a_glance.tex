...
\mainmenuopt{Settings} > \dropmenuopttwo{mActionOptions}{Project Properties} 
menu.
...
\minisec{Form annotations}\index{annotations}
...
\mainmenuopt{View} > \dropmenuopt{Live GPS tracking}. You will get a new 
