...
After activating the \toolbtntwo{mActionToggleEditing}{toogle editing} mode
for a layer, you will find another capture feature icon in the
\mainmenuopt{Edit} menu depending on the layer type (point, line or
polygon). \\
