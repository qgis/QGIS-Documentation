...
for l in $langs
  do
    ...
    if [[ "$build_ok" = "0" ]]; then
      ...
      time rsync -hvrzc --delete --progress build/html/$l root@195.201.96.242:/var/www/qgisdata/QGIS-Documentation-3.28/live/html
      time rsync -hvrzc --delete --progress build/pdf root@195.201.96.242:/var/www/qgisdata/QGIS-Documentation-3.28/live/html
      time rsync -hvrzc --delete --progress build/zip root@195.201.96.242:/var/www/qgisdata/QGIS-Documentation-3.28/live/html
    else
