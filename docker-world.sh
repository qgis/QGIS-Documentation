...
for LANG in en
  do
    ...
    time rsync -hvrzc --progress output/pdf/$LANG /var/www/qgisdata/QGIS-Documentation-3.4/live/html/pdf
    time rsync -hvrzc --progress output/html/$LANG /var/www/qgisdata/QGIS-Documentation-3.4/live/html
  done
