...
for l in $langs
  do
    ...
    if [[ "$build_ok" = "0" ]]; then
      ...
      time rsync -hvrzc --delete --progress build/pdf/$1 www2.qgis.org:/var/www/qgisdata/QGIS-Documentation-3.28/live/html/pdf
      time rsync -hvrzc --delete --progress build/zip/$1 www2.qgis.org:/var/www/qgisdata/QGIS-Documentation-3.28/live/html/zip
    else
