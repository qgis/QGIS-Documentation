...
for l in $langs
  do
    ...
    time rsync -hvrzc -e ssh --progress output/pdf/$l /var/www/qgisdata/QGIS-Documentation-2.18/live/html/pdf
    time rsync -hvrzc -e ssh --progress output/html/$l /var/www/qgisdata/QGIS-Documentation-2.18/live/html
  done
