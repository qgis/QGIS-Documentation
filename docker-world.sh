...
: ${langs:=en de es fi fr gl hi id it ja ko nl pl pt_BR pt_PT ro ru tr uk zh_Hant}
...
for l in $langs
  do
    ...
    time rsync -hvrzc -e ssh --progress output/pdf/$l qgis.osgeo.osuosl.org:/var/www/qgisdata/QGIS-Documentation-2.14/live/html/pdf
    time rsync -hvrzc -e ssh --progress output/html/$l qgis.osgeo.osuosl.org:/var/www/qgisdata/QGIS-Documentation-2.14/live/html
  done
