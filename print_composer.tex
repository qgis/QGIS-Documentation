...
It is possible to add parts of an attribute table of a vector layer to the 
print composer canvas.

\begin{figure}[ht]
\centering
\subfloat[table dialog]{\label{subfig:tabledialog1}\includegraphics[clip=true, width=0.4\textwidth]{print_composer_attribute1}}
\hspace{1cm}
\subfloat[general options dialog]{\label{subfig:tabledialog2}\includegraphics[clip=true, width=0.4\textwidth]{print_composer_attribute2}}
...
\begin{itemize}[label=--]
\item The \textbf{Table} dialog allows to draw an ellipse, rectangle, or
\end{itemize}
